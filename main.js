...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarRandomgen'),'<div style="padding:8px;width:250px;text-align:center;">{Current Version: 1.1.0}</div>','this');
			Game.attachTooltip(l('topbarIGM'),'<div style="padding:8px;width:250px;text-align:center;">The Creators Main Website</div>','this');
		...
		*/
		...
		{
			var str='';
			str+='<div class="icon" style="position:absolute;left:-9px;top:-6px;background-position:'+(-10*48)+'px '+(-6*48)+'px;"></div>'; //-10, 48|-6,48
